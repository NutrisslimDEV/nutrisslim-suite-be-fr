                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;">
                                    <span
                                        style="color: #999999; font-size: 14px; line-height: 19px;"><?php echo __('Numéro de commande :', 'woocommerce');?></span>
                    ...
                    <![endif]-->
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;">
                                    <span
                                        style="color: #999999; font-size: 14px; line-height: 19px;"><?php echo __('Montant', 'woocommerce');?>:</span>
                            ...
                            <div
                                ...
                                <p style="line-height: 36px; text-align: center; font-size: 12px; margin: 0;">
                                    <span style="font-size: 24px;">
                                        <strong><?php echo __('Commande', 'woocommerce');?></strong>
                                    </span>
                                </p>
                                <p
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 15px; text-align: center; margin: 0;"><span
                                        style="font-size: 14px; line-height: 19px; mso-ansi-font-size: 14px;"><strong><?php echo __('Produit', 'woocommerce'); ?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="line-height: 15px; text-align: center; font-size: 12px; margin: 0;"><span
                                        style="font-size: 14px; line-height: 19px; mso-ansi-font-size: 14px;"><strong><?php echo __('Quantité', 'woocommerce'); ?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; text-align: center; margin: 0;"><span
                                        style="font-size: 14px; line-height: 19px; mso-ansi-font-size: 14px;"><strong><?php echo __('Prix', 'woocommerce');?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;"><span
                                        style="font-size: 14px;"><?php echo __('Produits', 'woocommerce'); ?><br></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;">
                                    <span
                                        style="font-size: 14px;"><?php echo __('Montant des frais d\'expédition', 'woocommerce'); ?><br></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]>
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;"><span
                                        style="font-size: 14px;"><?php echo __(esc_html( $fee_name ), 'nutrisslim-suite'); ?><br><span
                                            style="font-size: 12px; line-height: 14px; white-space: nowrap;"><?php echo __('(Hors TVA)', 'woocommerce'); ?></span></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="font-size: 14px; line-height: 19px; margin: 0;">
                                    <?php echo __('Méthode de paiement: ', 'woocommerce'); ?></p>
                                <p style="font-size: 14px; line-height: 19px; margin: 0;"><span
