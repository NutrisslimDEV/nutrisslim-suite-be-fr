...
function add_to_cart_link() {
    echo '<div id="foocart"><a class="uwcc-open-cart-546612" href="#">Ajouter au panier</a></div>';
}
...
function custom_get_additional_fees_settings() {
    ...
    $additional_fees_settings = array(
        ...
        'priority_delivery' => array(
            'name' => __('Livraison prioritaire', 'nutrisslim-suite'),
            'type' => 'number',
        ...
        'package_insurance' => array(
            'name' => __('Assurance de la livraison', 'nutrisslim-suite'),
            'type' => 'number',
...
function add_custom_fees_to_cart() {
    ...
    $custom_fees = [
        ...
        'rf_zavarovanje_narocila' => [
            'label' => __('Assurance de la livraison', 'nutrisslim-suite'),
        ...
        'rf_priority_delivery' => [
            'label' => __('Livraison prioritaire', 'nutrisslim-suite'),
...
<div id="delivery-option" class="rf-custom-option">
    <h3><?php echo __('Choisissez une livraison rapide et sécurisée', 'nutrisslim-suite'); ?></h3>
    ...
    <div class="delivery-option rf-option-container" style="<?php echo $is_priority_delivery_bg; ?>">
        <div class="rf-option-left">
            ...
            <label for="rf_priority_delivery">
                <div class="rf-option-title"><?php echo __('Ignorez la ligne', 'nutrisslim-suite'); ?>
                    (+<?php echo wc_price($priority_delivery); ?>)</div>
                <div class="rf-option-description">
                    <?php echo __('Choisissez un emballage prioritaire pour l\'expédition la plus rapide. En choisissant cette option, votre commande sera traitée avant les autres.', 'nutrisslim-suite'); ?>
                </div>
            </label>
        </div>
    ...
    <div class="delivery-option rf-option-container" style="<?php echo $is_checked_zavarovanje_bg; ?>">
        <div class="rf-option-left">
            ...
            <label for="rf_zavarovanje_narocila">
                <div class="rf-option-title"><?php echo __('Assurance colis', 'nutrisslim-suite'); ?>
                    (+<?php echo wc_price($package_insurance); ?>)</div>
                <div class="rf-option-description">
                    <?php echo __('Sécurisez la livraison de votre colis et bénéficiez d’une solution garantie et gratuite en cas de produits endommagés ou manquants. Nous renverrons le colis sans frais supplémentaires.', 'nutrisslim-suite'); ?>
                </div>
            </label>
        </div>
...
<div class="rf-custom-option select-shipping">
    <h3><?php echo __('Livraison', 'woocommmerce'); ?></h3>
...
function custom_woocommerce_loop_add_to_cart_link($html, $product) {
    ...
    $custom_text = __( 'Ajouter au panier', 'woocommerce' );
...
function cart_upsell() {
    ...
    if (!empty($items)) {
        ...
        $output .= '<h3>' . __('Offre spéciale uniquement ici!', 'nutrisslim-suite') . '</h3>';
        $output .= '<p>' . __('Ajoutez pour commander et économiser!', 'nutrisslim-suite') . '</p>';
        ...
        foreach ($items as $item) {
            ...
            $output .= '<button class="cart-button_swiper add-to-cart-icon" data-offer="cart_upsell" data-product-id="' . $pid . '" data-quantity="1" data-price="' . $offer_price . '" ' . $disabled . '>' . __('Ajouter au panier', 'woocommerce') . '</button>';
...
function add_meta_to_order_fees($item, $fee_key, $fee, $order) {
    ...
    $fee_sifrant_map = array(
        ...
        'assurance-de-la-livraison' => get_option('custom_package_insurance_sifrant'),
